...
const DataLoaderPanel = (
    ...
    function retrieveArrivalsAndSchedules(startDate: Date, endDate: Date) {
        ...
        const status_header_data: StatusHeaderDataType = {
            ...
            phys_hourly_rate: chosenDepartment.phys_hourly_cost,
            phys_peak_capacity: chosenDepartment.phys_peak_capacity,
            app_hourly_rate: chosenDepartment.app_hourly_cost,
            app_peak_capacity: chosenDepartment.app_peak_capacity,
